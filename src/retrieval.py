...
class HybridRetriever:
    def __init__(self, vector_db_dir: Path, documents_dir: Path, reranking_provider: str = "dashscope", reranking_model: Optional[str] = None):
        self.vector_retriever = VectorRetriever(vector_db_dir, documents_dir)
        self.reranker = LLMReranker(provider=reranking_provider, model=reranking_model)
