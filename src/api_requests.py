        ...
        if not is_structured:
            ...
            try:
                ...
                if parsed_obj:
                    ...
                    # 如果没有 parsed 对象，手动解析 content
                    content = completion.choices[0].message.content
                    print(f"Warning: .parsed is None, manually parsing content: {content[:100]}...")
            except Exception as e:
                print(f"OpenAI parse failed: {e}. Falling back to manual parsing.")
                # 回退到普通 create 调用
            ...
            try:
                ...
                print(f"Error processing structured response: {err}")
                ...
                try:
                    ...
                    print(f"Reparse failed: {reparse_err}")
